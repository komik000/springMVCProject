...
<div class="" style="border-style: solid;width: 70%;margin: auto;border-color: #a7acb1;-webkit-box-shadow: 0 0 10px #fff;box-shadow: 0 0 10px #fff;">
    <div class="" style="">
        <div class="mb-4" style="background: gainsboro;width: 100%;height: 50px;">
            <h2 class="fw-bold " style="margin: 20px;">Signup Page</h2>
        </div>
        ...
        <form method="post" action="/signup">
            ...
            <div class="form-outline mb-4" style="display: flex;">
                ...
                <input type="email" id="form2Example4" name="email" style="width: 80%" class="form-control" />
            </div>

            <div class="form-outline mb-4" style="display: flex;">
                <label class="form-label" for="form3Example4" style="width: 20%;margin-left: 20px">Fullname</label>
                <input type="text" id="fullname" name="fullname" style="width: 80%" class="form-control" />
            </div>
            ...
            <div class="form-outline mb-4" style="display: flex;">
                <label class="form-label" for="form3Example4" style="width: 20%;margin-left: 20px">Confirmation </label>
                <input type="password" name="confirm" id="passwordConfirm" style="width: 80%" class="form-control" />
            </div>
